...
export class DataAccessorService {
  ...
  */
  ...
  addUser$(newUser: User): Observable<User> {
    return this.http
      .post<User>(`${environment.database.path}/users`, newUser, this.httpOptions)
      .pipe(
        catchError((err) => {
          throw this.handleFailure(err);
        })
  ...
  */
  ...
  getUserLogin$(id: string): Observable<Login> {
    return this.http.get<Login>(`${environment.database.path}/logins/${id}`).pipe(
      catchError((err) => {
        throw this.handleFailure(err);
      })
    );
  ...
  addUserPassword$(newLogin: Login): Observable<Login> {
    return this.http
      .post<Login>(`${environment.database.path}/logins`, newLogin, this.httpOptions)
      .pipe(
        catchError((err) => {
          throw this.handleFailure(err);
        })
  ...
  */
  ...
  getAllRubbish$(): Observable<Rubbish[]> {
    return this.http.get<Rubbish[]>(`${environment.database.path}/rubbishItems`).pipe(
      catchError((err) => {
        throw this.handleFailure(err);
      })
    );
  ...
  getRubbishByID$(id: string): Observable<Rubbish> {
    return this.http.get<Rubbish>(`${environment.database.path}/rubbishItems/${id}`).pipe(
      catchError((err) => {
        throw this.handleFailure(err);
      })
    );
  ...
  */
  ...
  getStagedRubbishByID$(id: string): Observable<StagedRubbish> {
    return this.http.get<StagedRubbish>(`${environment.database.path}/stagingArea/${id}`).pipe(
      catchError((err) => {
        throw this.handleFailure(err);
      })
    );
  ...
  */
  ...
  getAllDeposits$(): Observable<Deposit[]> {
    return this.http.get<Deposit[]>(`${environment.database.path}/deposits`).pipe(
      catchError((err) => {
        throw this.handleFailure(err);
      })
    );
  ...
  getDepositByID$(id: string): Observable<Deposit> {
    return this.http.get<Deposit>(`${environment.database.path}/deposits/${id}`).pipe(
      catchError((err) => {
        throw this.handleFailure(err);
      })
    );
  ...
  addDeposit$(newDeposit: Deposit): Observable<Deposit> {
    return this.http
      .post<Deposit>(`${environment.database.path}/deposits`, newDeposit, this.httpOptions)
      .pipe(
        catchError((err) => {
          throw this.handleFailure(err);
        })
  ...
  */
  ...
  getPromoByID$(id: string): Observable<Promo> {
    return this.http.get<Promo>(`${environment.database.path}/promo/${id}`).pipe(
      catchError((err) => {
        throw this.handleFailure(err);
      })
    );
  ...
  addPromo$(newPromo: Promo): Observable<Promo> {
    return this.http
      .post<Promo>(`${environment.database.path}/promo`, newPromo, this.httpOptions)
      .pipe(
        catchError((err) => {
          throw this.handleFailure(err);
        })
  ...
  */
  ...
  getBrandByID$(id: string): Observable<Brand> {
    return this.http.get<Brand>(`${environment.database.path}/brand/${id}`).pipe(
      catchError((err) => {
        throw this.handleFailure(err);
      })
    );
  ...
  addBrand$(newBrand: Brand): Observable<Brand> {
    return this.http
      .post<Brand>(`${environment.database.path}/brand`, newBrand, this.httpOptions)
      .pipe(
        catchError((err) => {
          throw this.handleFailure(err);
        })
